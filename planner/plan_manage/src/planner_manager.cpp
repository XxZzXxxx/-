...
namespace ego_planner
{
  ...
  void EGOPlannerManager::initPlanModules(ros::NodeHandle &nh, PlanningVisualization::Ptr vis)
  {
    ...
    visualization_ = vis;
    odom_to_decision_pub_ = nh.advertise<nav_msgs::Odometry>("/odom_to_decision", 10);
  }
                                        ...
                                        Eigen::Vector3d local_target_vel, bool flag_polyInit, bool flag_randomPolyTraj)
  {
    ...
    publishOdomToDecision(start_pt, start_vel);
                                         ...
                                         const Eigen::Vector3d &end_pos, const Eigen::Vector3d &end_vel, const Eigen::Vector3d &end_acc)
  {
    ...
    publishOdomToDecision(start_pos, start_vel);
...
void EGOPlannerManager::publishOdomToDecision(const Eigen::Vector3d& pos, const Eigen::Vector3d& vel)
{
    ...
    odom_to_decision_pub_.publish(odom_msg);
}
